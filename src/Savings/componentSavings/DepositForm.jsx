...
function DepositForm({
  ...
  const paymentOptions = [
    ...
    },
    {
      ...
      label: "QRPH",
      icon: (
        <img src={QRphIcon} className="w-5 h-5  object-contain" alt="QR PH" />
      ),
    },
    {
      value: "maya",
    ...
    <div className="flex flex-col mt-3 gap-3 bg-white p-5 rounded-xl border shadow-sm border-slate-100 dark:bg-slate-800 dark:border-slate-700">
      <div>
        ...
        {paymentMode === "online" ? (
          ...
          <>
            <div className="flex flex-col justify-center gap-3 p-4 mt-4 rounded-2xl bg-sky-50/50 border border-sky-100 dark:bg-sky-900/10 dark:border-sky-800/50">
